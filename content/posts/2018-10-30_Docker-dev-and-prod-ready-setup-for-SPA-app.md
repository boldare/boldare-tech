...
Of course, you're right, but let me explain it a bit more... 
...
On the other hand, we have **docker-compose**, which could manage services (containers) by `docker-compose.yml` file.
